...
pub fn MatchInfo(
    ...
    rsx! {
        div { class: "bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden",
            ...
            div { class: "p-6",
                div { class: "mb-4",
                    h3 { class: "text-lg font-semibold text-gray-700 dark:text-gray-300 mb-2", "Players" }
                    div { class: "flex flex-col gap-2",
                        div { class: "bg-blue-100 dark:bg-blue-900/20 p-3 rounded-md",
                            span { class: "font-semibold", "You" }
                            " {controller_player_name}"
                            if let Some(ref archetype) = controller_archetype {
                                span { class: "ml-2 px-2 py-0.5 text-xs rounded-full bg-violet-100 dark:bg-violet-900/40 text-violet-700 dark:text-violet-300",
                                    "{archetype}"
                                }
                            }
                        }
                        div { class: "bg-red-100 dark:bg-red-900/20 p-3 rounded-md",
                ...
                div { class: "mb-4",
                    h3 { class: "text-lg font-semibold text-gray-700 dark:text-gray-300 mb-2", "Game Details" }
                        ...
                        div { class: "bg-gray-100 dark:bg-gray-900/50 p-3 rounded-md",
                            ...
                            span { class: "font-medium",
                                if did_controller_win {
                                    span { class: "text-amber-600 dark:text-amber-400 font-bold", "Victory" }
                                } else {
                                    span { class: "text-red-600 dark:text-red-400 font-bold", "Defeat" }
                                }
                            }
                        }
                    }
